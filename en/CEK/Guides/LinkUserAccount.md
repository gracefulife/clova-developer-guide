...
| Client Secret     | A secret which has to be passed on along with **Client ID** when obtaining an access token with an authorization code. Enter this field when the method is set to the authorization code grant. |
