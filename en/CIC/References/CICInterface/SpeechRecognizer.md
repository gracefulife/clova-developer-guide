...
// Input additional user's voice generated by a SpeechRecognizer.ExpectSpeech directive message
{
        "header": {
...
* CIC does not provide intermediate result to your client by default. The `SpeechRecognizer.ShowRecognizedText` directive message will be returned only under special conditions.
