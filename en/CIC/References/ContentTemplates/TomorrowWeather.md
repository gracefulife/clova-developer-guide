...
| `highTempWeather`           | [StringObject](/CIC/References/ContentTemplates/Shared_Objects.md#StringObject) | An object containing weather when the temperature is at the highest  |
...
| `lowTempWeather`           | [StringObject](/CIC/References/ContentTemplates/Shared_Objects.md#StringObject) | An object containing weather when the temperature is at the lowest  |
| `type`                      | string | A content template delimiter. The value is always `"TomorrowWeather"`. |
