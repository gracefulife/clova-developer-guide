...
| lang  | string | 음성 합성에 사용할 언어. <ul><li>"ko": 한국어</li><li>"en": 영어</li><li>"ja": 일본어</li><li>"zh": 중국어</li></ul> | 필수    |
...
| ttsLang              | string  | 음성 합성에 사용할 언어. <ul><li>"ko": 한국어</li><li>"en": 영어</li><li>"ja": 일본어</li><li>"zh": 중국어</li></ul> | 선택    |
