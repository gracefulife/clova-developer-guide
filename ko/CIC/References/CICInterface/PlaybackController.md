...
## Mute directive {#Mute}
클라이언트에게 오디오 플레이어 볼륨을 음소거하도록 지시합니다.
...
클라이언트에게 오디오 플레이어 볼륨의 음소거를 해제하도록 지시합니다.
...
클라이언트에게 오디오 플레이어 볼륨을 낮추도록 지시합니다. 볼륨을 낮추는 정도는 각 클라이언트의 UX 기준을 따릅니다.
...
클라이언트에게 오디오 플레이어 볼륨을 높이도록 지시합니다. 볼륨을 올리는 정도는 각 클라이언트의 UX 기준을 따릅니다.
