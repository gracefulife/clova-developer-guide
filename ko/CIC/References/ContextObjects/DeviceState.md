...
클라이언트 기기의 비행기 모드 설정 정보를 가지는 객체입니다.
...
클라이언트 기기의 배터리 상태 정보를 가지는 객체입니다.
...
클라이언트 기기의 블루투스 활성화 상태 및 블루투스 기기 연결 상태 정보를 가지는 객체입니다.
...
클라이언트 기기의 GPS 상태 정보를 가지는 객체입니다.
...
클라이언트 기기의 사운드 모드 정보를 가지는 객체입니다.
...
클라이언트 기기의 스피커 볼륨 크기 정보를 가지는 객체입니다.
...
클라이언트 기기의 무선 네트워크(Wi-Fi) 기능 활성화 상태와 무선 네트워크 연결 정보를 가지는 객체입니다.
