...
클라이언트는 CIC API를 통해 사용자의 요청을 CIC로 전달하며 응답 결과를 CIC로부터 전달받습니다. CIC에 접속하기 위해 HTTP/2 프로토콜을 사용해야 하며, 음성 인식, 음성 출력, 음악 재생, 개인 일정 관리, 알람/타이머 설정과 같은 기능을 [API](/CIC/References/CIC_API.md)를 통해 제공하고 있습니다.
