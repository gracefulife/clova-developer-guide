...
<ol>
  ...
  <li>서비스의 access token을 획득 시 HTTPS 요청에 필요한 <strong>클라이언트 secret</strong>을 입력합니다. 클라이언트 secret은 <a href="/CEK/Guides/LinkUserAccount.md#BuildAuthServer">인증 서버를 구축</a>할 때 생성한 값입니다.</li>
