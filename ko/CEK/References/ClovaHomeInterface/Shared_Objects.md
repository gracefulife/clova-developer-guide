...
|---------------|---------|-----------------------------|---------|
| `value`       | string  | 공기질 상태. <ul><li><code>"좋음"</code></li><li><code>"보통"</code></li><li><code>"약간 나쁨"</code></li><li><code>"아주 나쁨"</code></li></ul>   | 필수     |
...
| `IncrementBrightness`        | [`IncrementBrightnessConfirmation`](/CEK/References/ClovaHomeInterface/Control_Interfaces.md#IncresementBrightnessConfirmation), [`IncrementBrightnessRequest`](/CEK/References/ClovaHomeInterface/Control_Interfaces.md#IncrementBrightnessRequest)  |
